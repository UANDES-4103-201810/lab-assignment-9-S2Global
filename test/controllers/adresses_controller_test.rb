...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { apartment: @adress.apartment, description: @adress.description, street: @adress.street, zipcode: @adress.zipcode } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { apartment: @adress.apartment, description: @adress.description, street: @adress.street, zipcode: @adress.zipcode } }
